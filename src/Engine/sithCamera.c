...
void sithCamera_FollowFocus(sithCamera *cam)
{
...
#ifdef TARGET_XBOX
    { static int _ff=0; if(_ff<1){ XDBGF("FollowFocus: pers=%d focus=%p fsec=%p\n", cam->cameraPerspective, (void*)focusThing, (void*)(focusThing ? focusThing->sector : NULL)); _ff++; } }
#endif
    ...
    switch ( cam->cameraPerspective )
    {
        ...
        case 32:
            ...
            v2.x = 0.0f; v2.y = 0.0f; v2.z = 0.05f;
