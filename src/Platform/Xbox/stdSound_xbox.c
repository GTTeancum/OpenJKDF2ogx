...
void stdSound_3DBufferRelease(stdSound_3dBuffer_t *p) { stdSound_BufferRelease(p); }
...
stdSound_3dBuffer_t *stdSound_BufferQueryInterface(stdSound_buffer_t *a1) { return a1; }
int  stdSound_3DSetMode(stdSound_3dBuffer_t *a1, int a2) { (void)a1; (void)a2; return 1; }
void stdSound_SetPositionOrientation(rdVector3 *p, rdVector3 *l, rdVector3 *u) { (void)p; (void)l; (void)u; }
void stdSound_SetPosition(stdSound_buffer_t *s, rdVector3 *p) { if (s && p) s->pos = *p; }
void stdSound_SetVelocity(stdSound_buffer_t *s, rdVector3 *v) { if (s && v) s->vel = *v; }
