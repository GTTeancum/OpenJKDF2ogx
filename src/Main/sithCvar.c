...
{
#ifdef TARGET_XBOX
    xbox_debug_Print("sithCvar_Startup: enter\n");
#endif
...
#ifdef TARGET_XBOX
    xbox_debug_Print("sithCvar_Startup: stdHashTable_New...\n");
    xbox_debug_Print(std_pHS ? "  std_pHS is valid\n" : "  std_pHS is NULL!\n");
    xbox_debug_Print(std_pHS && std_pHS->alloc ? "  alloc is valid\n" : "  alloc is NULL!\n");
#endif
    sithCvar_numRegistered = 0;
    sithCvar_pHashTable = stdHashTable_New(SITHCVAR_MAX_CVARS * 2);
#ifdef TARGET_XBOX
    xbox_debug_Print(sithCvar_pHashTable ? "sithCvar_Startup: hash table OK\n" : "sithCvar_Startup: hash table FAILED\n");
#endif
...
#ifdef TARGET_XBOX
    xbox_debug_Print("sithCvar_Startup: jkPlayer_StartupVars...\n");
#endif
    jkPlayer_StartupVars();
#ifdef TARGET_XBOX
    xbox_debug_Print("sithCvar_Startup: stdUpdater_StartupCvars...\n");
#endif
    stdUpdater_StartupCvars();

#ifdef TARGET_XBOX
    xbox_debug_Print("sithCvar_Startup: LoadGlobals...\n");
#endif
    sithCvar_LoadGlobals();

#ifdef TARGET_XBOX
    xbox_debug_Print("sithCvar_Startup: done\n");
#endif
    return 1;
}
