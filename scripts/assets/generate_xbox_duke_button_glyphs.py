...
BUTTONS = {
    ...
    "xbtn_ls": (238, 288, 382, 432),
    "xbtn_rs": (808, 288, 952, 432),
    "xbtn_ls_click": (428, 288, 572, 432),
    "xbtn_rs_click": (998, 288, 1142, 432),
    "xbtn_dpad_up": (226, 576, 394, 744),
    "xbtn_dpad_left": (606, 576, 774, 744),
    "xbtn_dpad_right": (796, 576, 964, 744),
    "xbtn_dpad_down": (416, 576, 584, 744),
}
